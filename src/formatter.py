...
def _add_premissas(wb, cfg: dict, data_hoje: str, n_fiis: int, n_acoes: int):
    ...
    rows = [
        ...
        (None, None),
        ("── FILTROS FII ──", None),
        ("Metodologia", "Filtros fixos + quartis"),
        ("DY mínimo", f"{cfg['filters']['dy_min']*100:.2f}%"),
        ("Liquidez mínima", f"R$ {cfg['filters']['liquidez_min']:,.0f}".replace(",", ".")),
        ("Patrimônio mínimo", f"R$ {cfg['filters']['patrimonio_min']:,.0f}".replace(",", ".")),
        ("P/VP", "≤ Q25"),
        ("Dividend Yield", "≥ Q75"),
        ("Liquidez", "≥ Q75"),
        ("Patrimônio", "≥ Q75"),
        ...
        ("── FILTROS AÇÕES ──", None),
        ("Metodologia", "Filtros fixos + quartis"),
        ("DY mínimo", f"{cfg['filters']['acoes']['dy_min']*100:.0f}%"),
        ("Volume mínimo", f"R$ {cfg['filters']['acoes']['volume_min']:,.0f}".replace(",", ".")),
        ("Market Cap mínimo", f"R$ {cfg['filters']['acoes']['market_cap_min']:,.0f}".replace(",", ".")),
        ("Preço/VPA", "≤ Q25"),
        ("Preço/Lucro", "≤ Q25"),
        ("EV/EBIT", "≤ Q25"),
        ("EV/EBITDA", "≤ Q25"),
